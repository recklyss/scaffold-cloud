...
CREATE TABLE `sys_i18n` (
  ...
  `text` varchar(256) NOT NULL COMMENT '默认内容',
...
) ENGINE=InnoDB AUTO_INCREMENT=134 DEFAULT CHARSET=utf8 COMMENT='国际化翻译表';
...
CREATE TABLE `sys_role_operate` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='操作员与角色关系表';
