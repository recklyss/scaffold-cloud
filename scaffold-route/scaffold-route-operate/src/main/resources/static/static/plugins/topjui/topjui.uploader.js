...
$(function () {
    upfileGrid = $("#upfileGrid").datagrid({
        ...
        columns: [[
            ...
            {
                field: 'progress', title: '上传进度', width: 180, fixed: true, formatter: function (value, rec) {
                var htmlstr = '<div class="topjui-progressbar progressbar" style="width: 170px; height: 20px;" value="' + value + '" text="' + value + '%">' +
    ...
    WebUploader.Uploader.register({
        ...
        beforeSendFile: function (file) {
            ...
            (new WebUploader.Uploader()).md5File(file, 0, 10 * 1024 * 1024).progress(function (percentage) {
                ...
                $.ajax({
                    type: "POST",
                    url:_ctx + "/system/attachment/md5Validate",
                    data: {
